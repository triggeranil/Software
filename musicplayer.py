...
class MediaPlayer:
    def __init__(self, window):
        ...
        self.next_icon = self.next_icon.resize((65, 65), Image.ANTIALIAS)
        self.next_icon = ImageTk.PhotoImage(self.next_icon)

        self.previous_icon = Image.open('images/previous.png')
        self.previous_icon = self.previous_icon.resize((65, 65), Image.ANTIALIAS)
        ...
        self.songs_list = tk.Listbox(self.root, width=30, height=20, bg="black", fg="cyan", relief="flat",
    ...
    def shuffle_songs(self):
        if self.songs_list.size() >= 1:
            ...
            songs_list = shuffle.myrandom(songs_list)
...
if __name__ == '__main__':
    ...
    #window.wm_iconbitmap('images/music.icon')
